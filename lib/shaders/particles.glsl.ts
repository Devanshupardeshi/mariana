...
void main() {
  ...
  float speed = mix(2.2, 6.5, uScrollProgress) * (0.6 + aSeed * 0.8);
  ...
  pos.x += sway * 1.4;
  pos.z += snoise(vec3(uTime * 0.12, aSeed * 7.0, pos.y * 0.04)) * 1.4;
...
void main() {
  ...
  float alpha = mask * uOpacity * (0.12 + brightness * 0.42);
